// A set of tools to analyze language. The goal is to get as close as possible to a complete set of rules for the english language. Hopefully, higher level structures in language like ideas, concepts and the like could be captured.
...
// TODO:
// - MORPH WORD ANALYZER:
//   - Break down words into phonemes and morphemes
//   - Generate a tree of possible words from a given root
//   - Learn new morphemes and exceptions automatically
//   - Implement for all kinds of words
//
// - CFG SENTENCE ANALYZER:
//   - Generate Context-Free grammar from sentences
//   - Learn new rules by reading text
//
// - SEMANTICS ANALYZER:
//   - Later
